# US Stock Analyzer — Selection Logic

## Screener Overview

Selects from **~96 S&P 100-style US large-caps** using **Turtle Trading + Dual Momentum** framework.

**Investment model:** $50 USD per recommendation (fractional shares supported).
...
| **Relative momentum** | 3-month return beats **SPY** 3-month return (market outperformance) |

**Why:** Only buys stocks winning on their own *and* outpacing the broad S&P 500.
...
|-----------|-------|-------|
| Universe | ~96 S&P 100 names | US large-cap stocks |
| Benchmark | SPY | For relative strength (Stage 2) |
...
| Per-pick allocation | $50 | Fractional shares OK |
...
- **Market context** (relative strength) — ignores stocks lagging the S&P 500
- **Volatility filters** (RSI, volume) — skips overextended or low-conviction moves

This is **short-term tactical**, suitable for swing traders or daily alert users who trade US equities.

**Fractional share support** allows small allocations ($50/stock) suitable for:
- Diversification across many names
- Low capital requirements
- Avoiding gap-gap risk in expensive stocks

---

## Universe

S&P 100 constituents are periodically refreshed from [S&P Global's official list](https://www.spglobal.com/spdji/en/indices/equity/sp-100/). Edit `us_universe.py` to update the ticker list.
